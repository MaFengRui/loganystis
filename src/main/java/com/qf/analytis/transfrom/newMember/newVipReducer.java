 ...
 * Time:上午8:46
 * Vision:1.1
 * Description:新增会员将,map的value进行去重
 */
public class newVipReducer extends Reducer<StatsUserDimension, TimeOutputValue,StatsUserDimension, OutputWritable> {
    private static final Logger logger = Logger.getLogger(newVipReducer.class);
    private OutputWritable v = new OutputWritable();
    //利用hashSet进行去重
    private Set unique = new HashSet();
    private MapWritable map = new MapWritable();
    public newVipReducer() {
