 ...
 * Time:上午8:46
 * Vision:1.1
 * Description:活跃会员对pv事件下的mid进行去重
 */
public class ActiveVipReducer extends Reducer<StatsUserDimension, TimeOutputValue,StatsUserDimension, OutputWritable> {
    private static final Logger logger = Logger.getLogger(ActiveVipReducer.class);
    private OutputWritable v = new OutputWritable();
    //利用hashSet进行去重
    private Set unique = new HashSet();
    private MapWritable map = new MapWritable();
    public ActiveVipReducer() {
