...
import com.qf.analytis.transfrom.newinstalluser.NewInstallUserMapper;
import com.qf.analytis.transfrom.newinstalluser.NewInstallUserReducer;
 ...
 * Description:活跃用户新增
 */
public class ActiveRunner implements Tool {
    private static final Logger logger = Logger.getLogger(ActiveRunner.class);
    private Configuration conf = new Configuration();
    //主函数－－入口
    public static void main(String[] args) {
        try {
            ToolRunner.run(new Configuration(),new ActiveRunner(),args);
        } catch (Exception e) {
...
//        conf.set(GlobalConstants.RUNNING_DATE,date);
        Job job = Job.getInstance(conf, "Actice_User_to_mysql");
        job.setJarByClass(ActiveRunner.class);
        //设置map参数
